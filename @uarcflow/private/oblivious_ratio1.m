function [alpha, F] = oblivious_ratio1(af, H, h)
%function [alpha, F] = oblivious_ratio(af, H, h)
%OBLIVIOUS_RATIO - Oblivious arc-flow routing 
%
% [alpha, F] = oblivious_ratio(af, H, h)
%
% ---------------------------------------------------------------------------
% DESCRIPTION
% ---------------------------------------------------------------------------
...
% sought for in the form of an function: r = Ft, t \in H.
