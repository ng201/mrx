function [xopt,obj,exitflag,lambda]=MRXSLscs(this,f,A,b,Aeq,beq,lb,ub,x0,options)
%MRXSLscs LP solver for full matrices.
%
% ---------------------------------------------------------------------------
% DESCRIPTION
% ---------------------------------------------------------------------------
%
% LP solver interface for sparse matrices.
%
% ---------------------------------------------------------------------------
% INPUT
% ---------------------------------------------------------------------------
...
if any(b<-this.Infty)
    error('MRXSLscs: Upper bound exceeded. Most probably the problem is unbounded.');
end
...
%                 end
    ...
    otherwise
        xopt=0; obj=0; lambda=[]; exitflag=-1;       
